    ...
    const initialize = async () => {
        try {
            ...
            const servicesInit = async () => {
                ...
                promises.push(SubscriptionService.initialize().then(() => console.log('✅ Subscription Service Ready')));

                if (Platform.OS !== 'web') {
                    console.log('🔄 Starting Database Service...');
                    promises.push(initDatabase().then(() => console.log('✅ Database Service Ready')));
                }
