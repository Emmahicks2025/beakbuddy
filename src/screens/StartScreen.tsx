                ...
                <Animated.View style={[
                    ...
                    <TouchableOpacity
                        ...
                        onLayout={(e) => {
                            ...
                            console.error(`📍 Google Button Layout: x=${x}, y=${y}, w=${width}, h=${height}`);
                        }}
                        onPress={() => {
                            console.error('???? Google Button PRESSED!');
                            handleGoogleLogin();
                        }}
                        activeOpacity={0.85}
                    >
                    ...
                    <TouchableOpacity
                        style={[styles.primaryButton, { marginTop: 12, backgroundColor: 'rgba(255,255,255,0.15)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.3)' }]}
